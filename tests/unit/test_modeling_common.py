...
# Genera un dataframe valido usando el factory de conftest
...
# comprueba que se detectan canales eeg no numericos (por ejemplo strings)
...
# comprueba que se aceptan csv sin columnas ID ni Class (modo inferencia)
...
# comprueba que una clase desconocida no rompe el mapeo (se devuelve como string)
