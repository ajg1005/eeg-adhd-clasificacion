...
app.include_router(model_registry_router, dependencies=[Depends(get_current_user)])
app.include_router(inference_router, dependencies=[Depends(get_current_user)])
